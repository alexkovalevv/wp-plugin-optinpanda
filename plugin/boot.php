<?php
	...
	if( is_admin() ) {
		require(OPTINPANDA_DIR . '/plugin/admin/boot.php');
	}
	...
	function optinpanda_subscription_services($services)
	{
		...
		$items = array(
			...
			'mailster' => array(
				'title' => __('Mailster', 'optinpanda'),
				'description' => __('Adds subscribers to the plugin Mailster.', 'optinpanda'),
				'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/mailster.png',
				'hover' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/colored/mailster.png',
				'class' => 'OPanda_MailsterSubscriptionService',
				'path' => OPTINPANDA_DIR . '/plugin/includes/subscription/mailster/class.mailster.php',
				'modes' => array('double-optin', 'quick-double-optin', 'quick')
			),
			'acumbamail' => array(
		...
		$items['pechkinmail'] = array(
			'title' => __('PechkinMail', 'bizpanda'),
			'description' => __('Adds subscribers to your PechkinMail account.', 'bizpanda'),
			'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/pechkinmail-logo.png',
		...
		$items['justclick'] = array(
			'title' => __('JustClick', 'bizpanda'),
			'description' => __('Adds subscribers to your JustClick account', 'bizpanda'),
			'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/justclick-logo.png',
			'hover' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/colored/justclick-logo.png',
			'class' => 'OPanda_JustClickSubscriptionService',
			'path' => OPTINPANDA_DIR . '/plugin/includes/subscription/justclick/class.justclick.php',
			'modes' => array('double-optin'),
		);

		$items['sendpulse'] = array(
			'title' => __('Sendpulse', 'bizpanda'),
			'description' => __('Adds subscribers to your Sendpulse account', 'bizpanda'),
			'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/sendpulse-logo.png',
			'hover' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/colored/sendpulse-logo.png',
			'class' => 'OPanda_SendPulseSubscriptionService',
			'path' => OPTINPANDA_DIR . '/plugin/includes/subscription/sendpulse/class.sendpulse.php',
			'modes' => array('quick'),
		);

		$items['mailerlite'] = array(
			'title' => __('Mailerlite', 'bizpanda'),
			'description' => __('Adds subscribers to your Mailerlite account', 'bizpanda'),
			'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/mailerlite-logo.png',
			'hover' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/colored/mailerlite-logo.png',
			'class' => 'OPanda_MailerLiteSubscriptionService',
			'path' => OPTINPANDA_DIR . '/plugin/includes/subscription/mailerlite/class.mailerlite.php',
			'modes' => array('double-optin', 'quick')
		);

		$items['unisender'] = array(
			'title' => __('Unisender', 'bizpanda'),
			'description' => __('Adds subscribers to your Unisender account.', 'bizpanda'),
			'image' => 'https://cconp.s3.amazonaws.com/optinpanda/mailing-services/gray/unisender-logo.png',
	...
	add_action('bizpanda_subscription_services', 'optinpanda_subscription_services');
