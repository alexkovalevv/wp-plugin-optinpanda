<?php
class OPanda_AWeberCollection extends OPanda_AWeberResponse implements ArrayAccess, Iterator, Countable {
    ...
    public function create($kv_pairs) {
        ...
        # Return new Resource
        // $url = $data['Location'];
        // $resource_data = $this->adapter->request('POST', $url);
    ...
    public function offsetGet($offset) {
        ...
        return new OPanda_AWeberEntry($entry, $entry_url, $this->adapter);
    }
