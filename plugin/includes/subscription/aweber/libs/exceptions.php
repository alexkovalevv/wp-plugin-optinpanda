...
class OPanda_AWeberException extends Exception { }
 ...
 * @version $id$
 */
class OPanda_AWeberAPIException extends OPanda_AWeberException {
 ...
 * @version $id$
 */
class OPanda_AWeberResourceNotImplemented extends OPanda_AWeberException {
 ...
 * @version $id$
 */
class OPanda_AWeberMethodNotImplemented extends OPanda_AWeberException {
 ...
 * @version $id$
 */
class OPanda_AWeberOAuthException extends OPanda_AWeberException {
 ...
 * @version $id$
 */
class OPanda_AWeberOAuthDataMissing extends OPanda_AWeberException {
 ...
 * @version $id$
 */
class OPanda_AWeberResponseError extends OPanda_AWeberException {
